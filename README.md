...
The other option is to click the green "clone or download" button and then click "Download ZIP". 
...
In this project we use Python Pandas & Python Matplotlib and Seaborn to analyze and answer business questions about 12 months worth of sales data. 
...
We added derived columns to aid our exploration
